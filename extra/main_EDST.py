...
def main():
    ...
    for i in range(args.iters):
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            save_dir = 'results' + '/' + str(args.model) + '/' + str(args.data) +  '/' + 'wd_' + str(args.weight_decay) + '/random' + '/seed' + str(args.seed) + '/density_' + str(
                args.density) + '/' + 'EDST' + '/ERK/' +  'M=' + str(args.model_num)
