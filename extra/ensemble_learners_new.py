...
# def adv_test(args,model, device, test_loader, mean, std, epsilon):
#     model.eval()
#     if args.use_bnn:
#         model.set_test_mean(False)
#     # Accuracy counter
        ...
        if args.resume:
                ...
                if 'adv' in args.mode:
                    ...
                    for file in range(0, len(model_files)):
                        ...
                        print_and_log('Generating Adversaial Datasets...')
                ...
                if 'tsne' == args.mode:
                    print_and_log("=> loading checkpoint '{}'".format(args.resume))
                    if args.dataset == 'cifar10':
                        file_path = "tsne_CF10_data.pt"
                    elif args.dataset == 'cifar100':
                        file_path = "tsne_CF100_data.pt"
