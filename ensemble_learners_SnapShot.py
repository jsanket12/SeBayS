...
def main():
    ...
    parser.add_argument('--initial-lr', type=float, default=0.1, metavar='LR',
    ...
    if args.resume:
        ...
        if 'ood' in args.mode:
            ...
            for file in range(0, len(model_files)):
                ...
                print('Ensemble Model Results: AUROC is {:.4f}, AUPRC is {:.4f}, Specificity is {:.4f}\n'.format(ens_AUROC, ens_AUPRC, ens_Specificity))
