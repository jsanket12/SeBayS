...
def get_cifar100_dataloaders(args, validation_split=0.0, max_threads=10):
    ...
    if validation_split > 0.0:
        ...
        valid_loader = torch.utils.data.DataLoader(
            val_dataset,
            len(val_dataset), #args.test_batch_size,
    ...
    test_loader = torch.utils.data.DataLoader(
        test_dataset,
        len(test_dataset), #args.test_batch_size,
        shuffle=False,
        num_workers=1,
        pin_memory=True)
    ...
    return train_loader, valid_loader, test_loader, single_test_loader
...
def get_cifar10_dataloaders(args, validation_split=0.0, max_threads=10):
    ...
    # split = int(np.floor(0.01 * len(test_dataset)))
    # single_test_dataset = DatasetSplitter(test_dataset, split_end=split)
    single_test_loader = torch.utils.data.DataLoader(
        test_dataset,
        batch_size=1,
        shuffle=False,
